...
export default class ScenePreload extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas('symbols', 'assets/atlas/symbols.png', 'assets/atlas/symbols.json');
    this.load.atlas('blurSymbols', 'assets/atlas/blurSymbols.png', 'assets/atlas/blurSymbols.json'); //не нормикс (чуже читается чем вариант выше)
    this.load.atlas('ui', 'assets/atlas/ui.png', 'assets/atlas/ui.json');
    this.load.atlas('PopUps', 'assets/atlas/PopUps.png', 'assets/atlas/PopUps.json');
    this.load.atlas('PopUps1', 'assets/atlas/PopUps1.png', 'assets/atlas/PopUps1.json');
    ...
    this.load.audio('bg_music', 'assets/sounds/Pirate Music.mp3');
    this.load.audio('click_sound', 'assets/sounds/click.wav');
    this.load.audio('spin_sound', 'assets/sounds/spin.mp3');
    this.load.audio('stop_sound', 'assets/sounds/stop.mp3');
